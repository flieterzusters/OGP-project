...
public class Asteroids<World, Ship, Asteroid, Bullet, Program> extends JFrame {
  ...
  public static void main(final String[] args) {
    ...
    // <begin>
    IFacade<asteroids.model.World, asteroids.model.Ship, asteroids.model.Asteroid, asteroids.model.Bullet, asteroids.model.Program> facade = new asteroids.model.Facade();
    // <end>
